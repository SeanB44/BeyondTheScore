...
raw.dat.full<-rbind(#read.xlsx("./Output/Modeling/Week_3_year_2023_Data.xlsx"),
      ...
      read.xlsx("./Output/Modeling/Week_9_year_2023_Data.xlsx"),
      read.xlsx("./Output/Modeling/Week_10_year_2023_Data.xlsx"),
      read.xlsx("./Output/Modeling/Week_11_year_2023_Data.xlsx"),
      read.xlsx("./Output/Modeling/Week_12_year_2023_Data.xlsx"),
      read.xlsx("./Output/Modeling/Week_13_year_2023_Data.xlsx"),
      read.xlsx("./Output/Modeling/Week_14_year_2023_Data.xlsx")
      )
###### Data Prep #######
...
mod.dat<-mod.dat%>%
  ...
  dplyr::select(-c(Win_pct_home, Win_pct_away)) #Creat Win_Pct_diff
cor(mod.dat$difference, mod.dat$win_pct_diff) #0.62
...
mean(abs(mod1.test.dat$predicted-mod1.test.dat$difference)/mod1.test.dat$difference) #-0.25 (25% closer than actual)
...
sum(mod1.test.dat$side)/nrow(mod1.test.dat) #87.9
